...
class GPA : public GPAInterface
{
  public:
	...
	//set of global constants for GPA grade
	const double Aflat = 4.0;
	const double Aminus = 3.7;
	const double Bplus = 3.4;
	const double Bflat = 3.0;
	const double Bminus = 2.7;
	const double Cplus = 2.4;
	const double Cflat = 2.0;
	const double Cminus = 1.7;
	const double Dplus = 1.4;
	const double Dflat = 1.0;
	const double Dminus = 0.7;
	const double Eflat = 0.0;
